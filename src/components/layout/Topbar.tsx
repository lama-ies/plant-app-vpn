...
const ITEMS: ItemNav[] = [
  ...
  { clave: 'filtros', a: '/filtros', etiqueta: 'nav.filtros', icono: <Filter size={16} aria-hidden />, perm: 'canConectarVpn' },
  ...
  { clave: 'gestionGerentes', a: '/gestion-gerentes', etiqueta: 'nav.gestionGerentes', icono: <Users size={16} aria-hidden />, perm: 'canGestionGerentes' },
